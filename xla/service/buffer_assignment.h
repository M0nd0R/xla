...
// An interface for tracking BufferAllocations across computations without a
// sequential ordering and defining the strategy for reusing existing
// allocations for HloBuffers.
